...
def main():
	...
	routerA.init(router.RouterCtrl.LS, 30, 60)
	...
	routerB.init(router.RouterCtrl.LS, 30, 60)
	...
	routerC.init(router.RouterCtrl.LS, 30, 60)
	...
	routerD.init(router.RouterCtrl.LS, 30, 60)
